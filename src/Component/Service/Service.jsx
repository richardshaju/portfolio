  ...
  return (
    <div className='service'>
        ...
        <div className='service-images'>
          <a href="mailto:richardshaju66@gmail.com?subject=Need a Static website&body=Hello Richard"> <div className="static" style={{textAlign:'center'}}>
                <img src={require('./static-website.png')} alt="" />
                <h2 className='caption'>Static Websites</h2>
          </div></a>
          <a href="mailto:richardshaju66@gmail.com?subject=Need a Web Application&body=Hello Richard"><div className="webapp" style={{textAlign:'center'}}>
