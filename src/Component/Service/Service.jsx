    ...
    <div className='service'>
        ...
        <div   className='service-images'>
         <div className="static" style={{textAlign:'center'}}>
           <a href="mailto:richardshaju66@gmail.com?subject=Need a Static website&body=Hello Richard"> 
                <img src={require('./static-website.png')} alt="" />
                <h2 className='caption'>Static Websites</h2>
                </a>
          </div>
         <div className="webapp" style={{textAlign:'center'}}>
         <a href="mailto:richardshaju66@gmail.com?subject=Need a Web Application&body=Hello Richard">
